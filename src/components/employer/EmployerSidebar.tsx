  ...
  return (
    <>
      ...
      {onClose && (
        <button
          onClick={onClose}
          className="md:hidden absolute top-4 right-4 z-10 w-10 h-10 flex items-center justify-center rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-900 transition-colors"
        ...
        <div className="flex flex-col gap-1.5 pb-2">
          {navigationItems.map((item, index) => (
            ...
            >
              ...
              <div className={`flex items-center justify-center w-5 h-5 md:w-4.5 md:h-4.5 sm:w-4 sm:h-4 flex-shrink-0 transition-all duration-200 ${
