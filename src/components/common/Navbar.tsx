...
import JobCategoryDropdown from '../jobs/JobCategoryDropdown';
...
const Navbar: React.FC = () => {
  ...
  const handleJobCategoryDropdownClose = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-[1000] transition-all duration-300 ease-out backdrop-blur-[20px] min-h-[56px] md:min-h-[80px] shadow-sm shadow-black/10">
      <div className="font-['Plus_Jakarta_Sans',sans-serif] container max-w-7xl mx-auto px-3 py-1.5 md:px-4 md:py-2.5 sm:px-3 sm:py-2 flex items-center justify-between min-h-[30px] md:min-h-[50px] sm:min-h-[45px] gap-1.5 sm:gap-3 md:gap-x-3 flex-nowrap">
        {/* Logo */}
        ...
        {/* Desktop Navigation */}
        <nav
          className="hidden md:flex items-center justify-start flex-1 lg:flex-initial order-3 md:order-2 lg:order-none"
          role="navigation"
          aria-label="Main navigation"
        >
          <ul className="flex items-center list-none m-0 p-0 gap-1 whitespace-nowrap flex-nowrap">
            {/* Home */}
            ...
            <li 
              className="relative"
              onMouseEnter={() => setIsJobCategoryDropdownOpen(true)}
              onMouseLeave={() => setIsJobCategoryDropdownOpen(false)}
            >
              <button 
                className={`flex items-center gap-1 text-gray-600 text-sm md:text-xs transition-all duration-200 ease-in-out relative bg-none border-none shadow-none m-0 py-2 px-2.5 md:py-1.5 md:px-2 rounded-lg cursor-pointer hover:bg-slate-50 hover:text-gray-800 ${isActive('/govt-jobs') || isActive('/internships') ? 'bg-blue-50 text-blue-600' : ''}`}
              ...
              <JobCategoryDropdown
                ...
                onClose={handleJobCategoryDropdownClose}
              />
            </li>
              ...
              <nav className="w-full" role="navigation" aria-label="Mobile navigation">
                <ul className="list-none m-0 p-0 flex flex-col gap-2">
                  ...
                  <li className="m-0">
                    <Link 
                      to="/govt-jobs" 
                      className={`flex items-center gap-3 py-4 px-5 md:py-3.5 md:px-4 sm:py-3.5 sm:px-4 text-gray-600 text-decoration-none font-medium text-base md:text-base sm:text-sm rounded-xl transition-all duration-200 ease-in-out bg-none border-none shadow-none m-0 w-full text-left hover:bg-slate-50 hover:text-gray-800 ${isActive('/govt-jobs') ? 'bg-blue-50 text-blue-600' : ''}`} 
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Govt Jobs
                    </Link>
                  ...
                  <li>
                    <Link 
                      to="/internships" 
                      className={`flex items-center gap-3 py-4 px-5 md:py-3.5 md:px-4 sm:py-3.5 sm:px-4 text-gray-600 text-decoration-none font-medium text-base md:text-base sm:text-sm rounded-xl transition-all duration-200 ease-in-out bg-none border-none shadow-none m-0 w-full text-left hover:bg-slate-50 hover:text-gray-800 ${isActive('/internships') ? 'bg-blue-50 text-blue-600' : ''}`} 
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Internships
                    </Link>
